...
INSERT INTO Suministros (codigo_suministro, codigo_proveedor, isbn, fecha, recibido) VALUES
...
SELECT cantidad FROM libros WHERE isbn = 9789876510012;
...
INSERT INTO Ventas (codigo_venta, codigo_cliente, isbn, fecha) VALUES
(500011, 10001, '9789876510012', '2025-04-12');
...
FOR EACH ROW
    UPDATE Libros
    SET cantidad = cantidad + NEW.recibido
    WHERE isbn = NEW.isbn;

SELECT cantidad FROM libros WHERE isbn = 9789871138002;
 
INSERT INTO Suministros (codigo_suministro, codigo_proveedor, isbn, fecha, recibido) VALUES
(700021, 101001, '9789871138002', '2025-03-15', 10);
